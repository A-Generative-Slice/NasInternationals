...
export const INITIAL_APPLICATIONS: ApplicationItem[] = [
  {
    ...
    payment: {
      ...
      amount: 8500,
      upiQrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=nastravels@hdfcbank&pn=NAS%20Travels%20Pvt%20Ltd&am=8500&cu=INR',
      bankName: 'HDFC Bank',
  ...
  },
  {
    ...
    payment: {
      ...
      amount: 6500,
      upiQrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=nastravels@hdfcbank&pn=NAS%20Travels',
      bankName: 'HDFC Bank',
      accountName: 'NAS Travels Pvt Ltd',
      accountNumber: '1234567890',
      ifscCode: 'HDFC0001234',
  ...
  },
  {
    ...
    payment: {
      ...
      amount: 5000,
      upiQrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=nastravels@hdfcbank&pn=NAS%20Travels&am=5000&cu=INR',
      bankName: 'HDFC Bank',
      accountName: 'NAS Travels Pvt Ltd',
      accountNumber: '1234567890',
      ifscCode: 'HDFC0001234',
