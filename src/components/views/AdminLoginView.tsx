...
export const AdminLoginView: React.FC = () => {
  ...
  return (
    <div className="bg-[#0B1E3D] min-h-[calc(100vh-5rem)] flex items-center justify-center p-4 sm:p-6 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#C8A24A_1px,transparent_1px)] [background-size:24px_24px] opacity-10 pointer-events-none"></div>
      ...
      <div className="bg-[#0f274e] rounded-3xl p-6 sm:p-10 max-w-md w-full border border-slate-700/80 shadow-2xl relative z-10 space-y-6">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-[#EAC166]/10 text-[#EAC166] border border-[#EAC166]/30 uppercase tracking-widest">
            <ShieldCheck className="w-3.5 h-3.5 text-[#EAC166]" />
            <span>PRIVATE ADMIN PORTAL (/admin/login)</span>
          </div>

          <div className="w-16 h-16 mx-auto rounded-2xl bg-[#0B1E3D] border border-[#EAC166]/40 text-[#EAC166] flex items-center justify-center font-black text-2xl shadow-xl">
            NAS
          </div>
        ...
        <div className="bg-[#0B1E3D] p-3.5 rounded-2xl border border-amber-500/30 text-xs text-amber-200/90 flex items-start space-x-2.5">
          <AlertTriangle className="w-4 h-4 text-[#EAC166] shrink-0 mt-0.5" />
        ...
        <form onSubmit={handleAdminSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#0B1E3D] border border-slate-600 rounded-xl py-2.5 pl-10 pr-3 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-[#EAC166] focus:ring-1 focus:ring-[#EAC166]"
              />
            </div>
          </div>
          ...
          <div className="bg-[#0B1E3D] p-3.5 rounded-2xl border border-slate-700 space-y-2">
            ...
            <div className="flex items-center space-x-3">
              <div className="px-3 py-2 bg-slate-800 font-mono font-bold text-sm text-[#EAC166] rounded-xl border border-slate-700 shrink-0 select-none">
                {num1} + {num2} = ?
              </div>
              <input
                type="text"
                ...
                placeholder="Answer"
                className="flex-1 bg-slate-900 border border-slate-600 rounded-xl p-2 text-xs text-white font-mono text-center focus:outline-none focus:border-[#EAC166]"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-[#EAC166] hover:bg-[#cba248] text-[#0B1E3D] font-display font-black text-xs rounded-xl shadow-lg transition-all flex items-center justify-center space-x-2 disabled:opacity-50"
          >
            {isLoading ? (
              <>
